  ...
  return (
    <Wrapper>
      ...
      <Confirm
        ...
        footer={
          <Space>
            <Button size="small" onClick={removeTab}>{t('discard')}</Button>
            <Button size="small" onClick={hideConfirm}>{t('cancel')}</Button>
            <Button size="small" onClick={runTab} type="primary">
              {t('execute')}
            </Button>
          </Space>
        }
