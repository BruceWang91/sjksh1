            ...
            isArchived ? (
              <>
                <Popconfirm title={t('sureToRestore')} onConfirm={unarchive}>
                  <Button size="small" loading={unarchiveLoading}>{t('restore')}</Button>
                </Popconfirm>
                <Popconfirm title={t('sureToDelete')} onConfirm={del(false)}>
                  <Button size="small" loading={deleteLoading} danger>
                    {t('delete')}
                  </Button>
                </Popconfirm>
              </>
                ...
                {!isAdd && (
                  ...
                  >
                    <Popconfirm
                      ...
                      onConfirm={del(true)}
                    >
                      <Button size="small" loading={deleteLoading} disabled={active} danger>
                        {t('moveToTrash')}
                      </Button>
                    </Popconfirm>
                  </Tooltip>
