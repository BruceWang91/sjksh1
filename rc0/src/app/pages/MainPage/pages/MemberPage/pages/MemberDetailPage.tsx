...
import { Button, Card, Form, Input, message, Popconfirm, Select,TreeSelect } from 'antd';
...
} from '../../departmentPage/slice/selectors';
import {
  getDepartments,
...
export function MemberDetailPage() {
  ...
  const departmentLoading = useSelector(selectDepartmentListLoading);
  ...
  return (
    <Wrapper>
      <DetailPageHeader
        ...
        actions={
          <>
            <Button type="primary" size="small" loading={saveMemberLoading} onClick={save}>
              {tg('button.save')}
            </Button>
              ...
              <>
                ...
                {isPlatformMode ? (
                  <Popconfirm title={t('removeConfirm')} onConfirm={remove}>
                    <Button size="small" loading={removeMemberLoading} danger>
                      {t('remove')}
                    </Button>
                  </Popconfirm>
                ) : (
